...
fun SettingsScreen(
    ...
    title: String = "Módulo de Configurações e Temas WGC"
) {
    Column(
        ...
        Text(text = "Configuração de aparência, temas WGC, idioma e In-App Updates", style = MaterialTheme.typography.bodyMedium)
    }
}
