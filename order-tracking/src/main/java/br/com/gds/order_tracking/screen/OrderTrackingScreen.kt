...
fun OrderTrackingScreen(
    ...
    title: String = "Módulo de Acompanhamento de Pedido WGC"
) {
    Column(
        ...
        Text(text = "Stepper de status em tempo real, cronômetro ETA e contato rápido WGC", style = MaterialTheme.typography.bodyMedium)
    }
}
