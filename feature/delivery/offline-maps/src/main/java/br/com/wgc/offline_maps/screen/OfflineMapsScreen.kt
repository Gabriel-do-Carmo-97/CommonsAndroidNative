...
/**
 * Tela do módulo de Mapas Offline e Cache Local de Rotas.
 *
 * Exibe regiões baixadas para visualização sem conectividade e status
 * do armazenamento interno de cartografia vetorial.
 *
 * @param modifier Modificador Compose aplicado na raiz do contêiner.
 * @param title Título customizado exibido no topo.
 */
@Composable
