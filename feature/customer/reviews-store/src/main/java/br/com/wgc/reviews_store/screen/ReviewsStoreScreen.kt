...
/**
 * Tela inteligente para fomento de avaliações na Google Play Store.
 *
 * Implementa estratégia de triagem inteligente (smart review gating): avaliações altas
 * (4 ou 5 estrelas) são direcionadas à Play Store oficial, enquanto avaliações mais baixas
 * são coletadas internamente como feedbacks de melhoria contínua.
 *
 ...
 * @param viewModel ViewModel injetado responsável pela triagem das notas e comentários.
 */
@Composable
