    ...
    Column(
        ...
        Card(
            ...
            colors = CardDefaults.cardColors(
                containerColor = if (uiState.isAuthenticated) MaterialTheme.colorScheme.primaryContainer else MaterialTheme.colorScheme.surfaceVariant
            )
        ) {
            Column(
                ...
                Button(
                    ...
                    enabled = uiState.isBiometricReady && activity != null,
                    modifier = Modifier.fillMaxWidth()
                ) {
                    Text(if (uiState.isAuthenticated) "Autenticar Novamente" else "Entrar com Digital / Face ID")
                }
