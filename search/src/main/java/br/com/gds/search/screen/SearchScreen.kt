...
fun SearchScreen(
    ...
    title: String = "Módulo de Busca Reativa e Filtros WGC"
) {
    Column(
        ...
        Text(text = "Barra de busca com debounce, histórico salvo e filtros dinâmicos WGC", style = MaterialTheme.typography.bodyMedium)
    }
}
