...
fun CatalogScreen(
    ...
    title: String = "Módulo de Catálogo e Cardápio Digital WGC"
) {
    Column(
        ...
        Text(text = "Cardápio digital, seleção de produtos, tamanhos P/M/G e adicionais WGC", style = MaterialTheme.typography.bodyMedium)
    }
}
