...
fun ProfileScreen(
    ...
    title: String = "Módulo de Perfil e Privacidade LGPD WGC"
) {
    Column(
        ...
        Text(text = "Gestão de perfil, avatar, endereço e privacidade LGPD via WGC Core/DS", style = MaterialTheme.typography.bodyMedium)
    }
}
